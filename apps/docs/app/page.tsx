      ...
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-12 px-6 py-24">
        <div className="flex flex-col gap-4">
          ...
          <p className="max-w-xl text-lg text-fd-muted-foreground">
            A personal, self-hosted shadcn registry. Every codenamed design system is fully self-contained and
        ...
        <Link
          href="/docs"
          className="group flex w-fit items-center gap-2 rounded-lg border px-5 py-3 transition-colors hover:bg-fd-accent"
        >
