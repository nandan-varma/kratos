...
/**
 * STREAMING TEXT
 * Words resolve out of blur, inline citations appear in context, then
 * actions and follow-up prompts become usable.
 */
          ...
          <span className="flex -space-x-1">
            {SOURCES.map((source) => (
              <img
                ...
                src={source.image}
                alt=""
                className="size-3.5 rounded-full bg-surface shadow-[0_0_0_1.5px_var(--canvas)]"
              />
            ))}
          </span>
        ...
        <div className="mt-0.5 flex flex-col">
          {FOLLOW_UPS.map((text, i) => (
            <button
              ...
              duration-100 hover:bg-hover-2 active:scale-[0.96]"
              style={
                done
                  ? {
